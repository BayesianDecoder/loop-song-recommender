...
class HybridRecommenderSystem:
    ...
    def __calculate_content_based_similarities(self,song_name, songs_data,transformed_matrix):
        # filter out the song from data
    ...
    def __calculate_collaborative_filtering_similarities(self, song_name, track_ids, songs_data, interaction_matrix):
        # fetch the row from songs data
        song_row = songs_data.loc[(songs_data["name"] == song_name)]
        # track_id of input song
        input_track_id = song_row['track_id'].values.item()
    ...
    def give_recommendations(self, song_name, songs_data, track_ids, transformed_matrix, interaction_matrix):
        # calculate content based similarities
        content_based_similarities = self.__calculate_content_based_similarities(song_name= song_name, 
